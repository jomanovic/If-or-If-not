...
"""
    This parser was created by the authors of "Can Neural Networks Understand 
    Logical Entailment" for the purpose of training the PossibleWorldsNet model:
    https://github.com/deepmind/logical-entailment-dataset/blob/master/parser.py
"""
...
class Parser(object):
  ...
  def parse(self, expression):
    ...
    symbol_to_index = {symbol: index for index, symbol in enumerate(self.language.symbols)}
    symbols = [symbol_to_index[ix] for ix in parsed.ops]
    return symbols, parsed.inputs
